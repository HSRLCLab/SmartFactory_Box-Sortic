...
#define SMARTBOX_WAITFOR_VEHICLES_SECONDS 3      // SB waits this amount of seconds for vehicles to respond
#define SMARTBOX_ITERATION_VACKS_SECONDS 3       // SB waits this amound of secnods for vehicles to send their acknoledgement to transport SB
#define SMARTBOX_ITERATION_VTRANSPORTS_SECONDS 3 // SB waits this amount of seconds for vehicles to respond
